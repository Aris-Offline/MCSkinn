    ...
    public class SkinTreeView : TreeView
    {
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (diff.X >= mouseDownMargin || diff.Y >= mouseDownMargin)
            {
				...
				kvps.Add(new KeyValuePair<string, object>("MCSkinn.Skin", SelectedNode));
                ...
                obj.SetData("MCSkinn.Skin", SelectedNode.FullPath);
        ...
        {
            if (e.Data.GetDataPresent("MCSkinn.Skin") && _dragNode != null)
            {
            ...
            else if (e.Data.GetDataPresent(DataFormats.FileDrop))
            {
                ...
                //DropTargetHelper.DragEnter(this, e.Data, new Point(e.X, e.Y), e.Effect, Editor.GetLanguageString("C_IMPORTTO") + " %1", "MCSkinn");
            }
        }
        ...
        protected override void OnDragDrop(DragEventArgs e)
        {
            ...
            if (e.Data.GetDataPresent(DataFormats.FileDrop) &&
                !e.Data.GetDataPresent("MCSkinn.Skin"))
            {
                e.Effect = e.AllowedEffect & DragDropEffects.Copy;
