...
{
    [Serializable]
    public class SkinNode : LibraryNode, IDisposable, INotifyPropertyChanged
    {
        ...
        public override LibraryNodeType NodeType => LibraryNodeType.Skin;

        public SkinNode(string fileName, FolderNode parent = null)
        {
        ...
        public SkinNode(FileInfo file, FolderNode parent) :
        ...
        static void SetImage(SkinNode skin)
        {
        ...
        public void Resize(int width, int height, SkinSizeMismatchResizeType type = SkinSizeMismatchResizeType.Scale)
        {
            using (var newBitmap = new Bitmap(width, height))
            {
                using (Graphics g = Graphics.FromImage(newBitmap))
                {
                    ...
                    {
                        if (type == SkinSizeMismatchResizeType.Scale)
        ...
        public override void Reload()
        {
            ...
            Program.Editor.InvalidateRenderer();
            
            if(SkinLibrary.SelectedNode == this)
            {
                SkinLibrary.SelectedNode = this;
            }
        }

    }

    public enum SkinSizeMismatchResizeType
    {
        Scale,
        Crop,
        None,
