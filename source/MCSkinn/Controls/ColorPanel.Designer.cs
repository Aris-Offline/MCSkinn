namespace MCSkinn.Controls
{
	partial class ColorPanel
	{
		...
		private void InitializeComponent()
		{
			...
			this.colorPick1 = new MCSkinn.lemon42.ColorPick();
			...
			this.swatchContainer = new MCSkinn.SwatchContainer();
			...
			this.swatchContainer.SwatchChanged += new System.EventHandler<MCSkinn.SwatchChangedEventArgs>(this.swatchContainer_SwatchChanged);
			// 
			// languageProvider1
			// 
